...
def main():
    ...
    DEPs=pd.read_csv('./a2_PostvsPre_RNR_deg2.txt', sep='\t', header=0)
    DEPs=DEPs[DEPs['type']!='NOT']
    ...
    X_train_idx, X_val_idx, y_train_idx, y_val_idx = train_test_split(sampleInfor, sampleInfor['state'],
        test_size=0.2, random_state=260520, stratify=sampleInfor['state'])
    ...
    lr_bundle = {
        ...
        'metrics': lr_metrics,}
    joblib.dump(lr_bundle, 'final_model_lr_aP40.pkl')
    print("Saving: final_model_lr_aP40.pkl")
